...
export const profileImage = 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face';

export const collectibleBadges = [
...
export const interests = [
  ...
  { text: '🎸 rock', bg: '#FFE500', color: '#000', r: '3deg' },
  { text: '📸 film skate clips', bg: '#00FF88', color: '#000', r: '2.5deg' },
  ...
  { text: '🏎️ Audi', bg: '#9c9c9c', color: '#fff', r: '3.5deg' },
];
